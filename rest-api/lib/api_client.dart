  ...
  dynamic _deserialize(dynamic value, String targetType) {
    try {
      switch (targetType) {
        ...
        case 'Economics':
          return Economics.fromJson(value);
        case 'InlineObject':
        ...
        case 'InlineResponse4001':
          return InlineResponse4001.fromJson(value);
        case 'InlineResponse403':
          return InlineResponse403.fromJson(value);
        case 'Law':
          return Law.fromJson(value);
        case 'ManagedAuthClient':
          return ManagedAuthClient.fromJson(value);
        case 'ManagedAuthToken':
          return ManagedAuthToken.fromJson(value);
        case 'Military':
          return Military.fromJson(value);
        case 'MilitaryTechnology':
          return MilitaryTechnology.fromJson(value);
        case 'MilitaryUnit':
          return MilitaryUnit.fromJson(value);
        case 'MilitaryUnit1':
          return MilitaryUnit1.fromJson(value);
        case 'NewStateRequest':
          return NewStateRequest.fromJson(value);
        case 'People':
          return People.fromJson(value);
        case 'State':
          return State.fromJson(value);
        case 'State1':
          return State1.fromJson(value);
        case 'User':
          return User.fromJson(value);
        case 'User1':
          return User1.fromJson(value);
        default:
          {
            Match match;
            if (value is List &&
